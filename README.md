...
1MB CMI Project version **0.5.14** (June 14th, 2023), for live-1mb-3.3.0-mc-1.19.4
...
```
**TLDR;** These files are for 1.20.1 and probably any CMI version 9.9.0.x / CMILib 1.3.0.x
