...
1MB CMI Project version **0.5.15** (June 15th, 2023), for live-1mb-3.3.0-mc-1.19.4
...
```
**TLDR;** These files are for 1.20.1 and probably any CMI version 9.6.0.x / CMILib 1.3.0.x
