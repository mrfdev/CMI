...
1MB CMI Project version **1.0.1 build 110** (October 17th, 2024), for live-1mb-3.7.2-mc-1.21.1

**TLDR;** These files are for 1.21.1 and probably any CMI version 9.7.x.x / CMILib 1.5.x.x 
