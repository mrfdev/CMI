# Clean list of all permission nodes in CMI

Clean list of available permissions that come with CMI that you can use in your custom alias commands, permissions manager, etc.
...
cmi.command.armorstand.template. - Allows to deploy saved armor stands
...
```
  cmi.command.actionbarmsg:
    ...
    default: op
  cmi.command.afk:
    description: Toggle afk mode. Reason could be provided
    default: op
  cmi.command.afk.others:
    default: op
  cmi.command.afkcheck:
    description: Check players afk status
    default: op
  cmi.command.afkcheck.others:
    default: op
  cmi.command.air:
    description: Set players air
    default: op
  cmi.command.air.others:
    default: op
  cmi.command.alert:
    description: Alerts administration on players login
    default: op
  cmi.command.alertlist:
    description: Lists all recorded alerts
    default: op
  cmi.command.aliaseditor:
    description: Alias editor
    default: op
  cmi.command.anvil:
  ...
  cmi.command.armorstand:
    ...
    default: op
  cmi.command.attachcommand:
    description: Attaches command to item
    default: op
  cmi.command.autorecharge:
    description: Toggle auto flight recharge
    default: op
  cmi.command.autorecharge.others:
    default: op
  cmi.command.back:
    description: Teleports back to last saved location
    default: op
  cmi.command.back.others:
    default: op
  cmi.command.balance:
    description: Check money balance
    default: op
  cmi.command.balance.others:
    default: op
  cmi.command.baltop:
    description: Check top money list
    default: op
  ...
  cmi.command.banlist:
    ...
    default: op
  cmi.command.bbroadcast:
    description: Sends special message to all players on all servers
    default: op
  cmi.command.blockcycling:
    description: Cycle block states
    default: op
  cmi.command.blockinfo:
    description: Check block information
    default: op
  cmi.command.blocknbt:
    description: Show block NBT information
    default: op
  cmi.command.book:
    description: Book editing
    default: op
  cmi.command.bossbarmsg:
    description: Sends boss bar message to player
    default: op
  cmi.command.broadcast:
    description: Sends special message to all players
    default: op
  cmi.command.burn:
  ...
  cmi.command.burn.others:
    default: op
  cmi.command.cartographytable:
    description: Open cartography table
    default: op
  cmi.command.cartographytable.others:
    default: op
  cmi.command.charges:
    description: Shows left spawner charges
    default: op
  ...
  cmi.command.chat:
    ...
    default: op
  cmi.command.checkaccount:
    description: Search for a players other accounts
    default: op
  cmi.command.checkban:
    description: Check players ban status
    default: op
  cmi.command.checkcommand:
    description: Search for possible commands by keyword
    default: op
  cmi.command.checkexp:
    description: Check players exp
    default: op
  cmi.command.checkexp.others:
    default: op
  cmi.command.checkperm:
    description: Check possible permission nodes
    default: op
  cmi.command.cheque:
    description: Convert money into cheque
    default: op
  cmi.command.clear:
  ...
  cmi.command.clear.others:
    default: op
  cmi.command.clearchat:
    description: Clears chat
    default: op
  cmi.command.clearender:
    description: Clear players ender chest
    default: op
  cmi.command.clearender.others:
    default: op
  cmi.command.colorlimits:
    description: Shows all possible colors
    default: op
  cmi.command.colorlimits.others:
    default: op
  cmi.command.colorpicker:
    description: Pick hex color
    default: op
  ...
  cmi.command.compass.others:
    default: op
  cmi.command.condense:
    description: Condense items into blocks
    default: op
  cmi.command.condense.others:
    default: op
  cmi.command.counter:
    description: Starts counter for surrounding players
    default: op
  cmi.command.cplaytime:
    description: Detailed playtime
    default: op
  cmi.command.cplaytime.others:
    default: op
  cmi.command.ctellraw:
    description: Send tellraw type message
    default: op
  cmi.command.ctext:
  ...
  cmi.command.ctext.others:
    default: op
  cmi.command.cuff:
    description: Suspends players actions
    default: op
  cmi.command.customrecipe:
    description: Manages item custom recipes
    default: op
  cmi.command.dback:
    description: Returns to death location
    default: op
  cmi.command.dback.others:
    default: op
  cmi.command.disableenchant:
    description: Disable enchantment
    default: op
  cmi.command.dispose:
    description: Dispose of unneeded items
    default: op
  cmi.command.dispose.others:
    default: op
  cmi.command.distance:
    description: Check distance between 2 points
    default: op
  cmi.command.distance.others:
    default: op
  cmi.command.donate:
    description: Donate item you are holding
    default: op
  cmi.command.dsign:
    description: Manage dynamic signs
    default: op
  cmi.command.dye:
  ...
  cmi.command.dye.others:
    default: op
  cmi.command.editctext:
    description: Custom text editor
    default: op
  cmi.command.editlocale:
    description: Edit your locale file
    default: op
  cmi.command.editplaytime:
    description: Edit players playtime
    default: op
  cmi.command.editplaytime.others:
    default: op
  cmi.command.editwarnings:
    description: Check player warnings
    default: op
  cmi.command.editwarnings.others:
    default: op
  cmi.command.editwarp:
    description: Edit warps
    default: op
  cmi.command.editwarp.others:
    default: op
  cmi.command.effect:
    description: Adds potion effect to player. use clear to remove all effects
    default: op
  ...
  cmi.command.enchant.others:
    default: op
  cmi.command.ender:
    description: Opens players ender chest
    default: op
  cmi.command.ender.others:
    default: op
  cmi.command.endgateway:
    description: Toggle end gateway beam
    default: op
  ...
  cmi.command.ext.others:
    default: op
  cmi.command.falldistance:
    description: Set players falldistance
    default: op
  ...
  cmi.command.feed.others:
    default: op
  cmi.command.findbiome:
    description: Finds nearest biome by name
    default: op
  cmi.command.fixchunk:
    description: Scans for damaged chunks
    default: op
  cmi.command.flightcharge:
    description: Manage and check flight charges
    default: op
  cmi.command.flightcharge.others:
    default: op
  cmi.command.fly:
    description: Set players fly true or false
    default: op
  cmi.command.fly.others:
    default: op
  cmi.command.flyc:
    description: Toggle flight charge mode
    default: op
  cmi.command.flyc.others:
    default: op
  cmi.command.flyspeed:
    description: Set players fly speed from 0 to 10
    default: op
  cmi.command.flyspeed.others:
    default: op
  cmi.command.gamerule:
    description: Manage gamerules
    default: op
  cmi.command.generateworth:
    description: Auto generate posible item worth values
    default: op
  cmi.command.getbook:
  ...
  cmi.command.give.others:
    default: op
  cmi.command.giveall:
    description: Give item for all players
    default: op
  cmi.command.glow:
    description: Set players glow mode
    default: op
  cmi.command.glow.others:
    default: op
  cmi.command.gm:
    description: Set players game mode
    default: op
  cmi.command.god:
    description: Set players god mode to true or false
    default: op
  cmi.command.god.others:
    default: op
  cmi.command.grindstone:
    description: Open grindstone
    default: op
  cmi.command.grindstone.others:
    default: op
  cmi.command.groundclean:
    description: Clears server from unnecessary items
    default: op
  cmi.command.haspermission:
    description: Check if player has particular permission
    default: op
  cmi.command.haspermission.others:
    default: op
  cmi.command.hat:
    description: Place item like hat
    default: op
  ...
  cmi.command.heal.others:
    default: op
  cmi.command.helpop:
    description: Sends message for help to staff members
    default: op
  cmi.command.hideflags:
    description: Hides item flags
    default: op
  cmi.command.hideflags.others:
    default: op
  cmi.command.hologram:
    description: Manage holograms
    default: op
  cmi.command.hologrampages:
    description: Change hologram page
    default: op
  ...
  cmi.command.home.others:
    default: op
  cmi.command.homes:
    description: A list of homes that you can click to teleport to.
    default: op
  cmi.command.homes.others:
    default: op
  cmi.command.hunger:
    description: Set players hunger
    default: op
  cmi.command.hunger.others:
    default: op
  cmi.command.ic:
    description: Create interactive command
    default: op
  cmi.command.ifoffline:
    description: Perform command only when player is offline
    default: op
  cmi.command.ifonline:
    description: Perform command only when player is online
    default: op
  cmi.command.ignore:
  ...
  cmi.command.ignore.others:
    default: op
  cmi.command.importfrom:
    description: Import data from other plugins
    default: op
  cmi.command.importoldusers:
    description: Imports users from playerdata folder in main world folder. Server can suffer lag spike during import
    default: op
  cmi.command.info:
    description: Show players information
    default: op
  cmi.command.info.others:
    default: op
  cmi.command.inv:
    description: Opens players inventory
    default: op
  cmi.command.invcheck:
    description: Open saved inventory in preview mode
    default: op
  cmi.command.invcheck.others:
    default: op
  cmi.command.invlist:
    description: Show saved inventories list
    default: op
  cmi.command.invlist.others:
    default: op
  cmi.command.invload:
    description: Load saved inventory
    default: op
  cmi.command.invload.others:
    default: op
  cmi.command.invremove:
    description: Remove saved inventories for player
    default: op
  cmi.command.invremove.others:
    default: op
  cmi.command.invremoveall:
    description: Removes all saved inventories
    default: op
  cmi.command.invsave:
  ...
  cmi.command.ipban:
    description: Ban ip
    default: op
  cmi.command.ipbanlist:
    description: Ban ip list
    default: op
  cmi.command.item:
    description: Give item to yourself
    default: op
  cmi.command.itemcmdata:
    description: Check or modify items custom model data
    default: op
  cmi.command.itemcmdata.others:
    default: op
  cmi.command.itemframe:
    description: Manage item frames
    default: op
  cmi.command.iteminfo:
    description: Show item information
    default: op
  cmi.command.iteminfo.others:
    default: op
  cmi.command.itemlore:
    description: Change items lore
    default: op
  cmi.command.itemlore.others:
    default: op
  cmi.command.itemname:
    description: Rename items
    default: op
  cmi.command.itemname.others:
    default: op
  cmi.command.itemnbt:
    description: Show item NBT information
    default: op
  cmi.command.itemnbt.others:
    default: op
  cmi.command.jail:
    description: Jail player for time period
    default: op
  cmi.command.jailedit:
    description: Edit jails
    default: op
  cmi.command.jaillist:
    description: List jails
    default: op
  cmi.command.jump:
    description: Jump to target block
    default: op
  cmi.command.kick:
    description: Kick player with custom message
    default: op
  cmi.command.kill:
    description: Kill player
    default: op
  cmi.command.killall:
    description: Kill mobs around you
    default: op
  cmi.command.kit:
  ...
  cmi.command.kit.others:
    default: op
  cmi.command.kitcdreset:
    description: Reset kit timer
    default: op
  cmi.command.kitcdreset.others:
    default: op
  cmi.command.kiteditor:
    description: Kit editor.
    default: op
  cmi.command.kitusagereset:
    description: Reset kit usage counter
    default: op
  cmi.command.kitusagereset.others:
    default: op
  cmi.command.lastonline:
    description: Show played players from last x minutes
    default: op
  cmi.command.launch:
    description: Launch at direction you are looking or at angle
    default: op
  cmi.command.launch.others:
    default: op
  cmi.command.lfix:
    description: Fix light in chunks around you
    default: op
  cmi.command.list:
    description: Shows online player list
    default: op
  cmi.command.lockip:
    description: Prevents logging into account from different ip
    default: op
  cmi.command.lockip.others:
    default: op
  cmi.command.loom:
    description: Open loom
    default: op
  ...
  cmi.command.mail.others:
    default: op
  cmi.command.mailall:
    description: Check or send mail to all players
    default: op
  cmi.command.maintenance:
    description: Set server into maintenance mode
    default: op
  cmi.command.maxhp:
  ...
  cmi.command.maxhp.others:
    default: op
  cmi.command.maxplayers:
    description: Changes maximum amount of players who can connect to server
    default: op
  cmi.command.me:
    description: Sends special message to all players
    default: op
  cmi.command.merchant:
    description: Open merchant trade window
    default: op
  cmi.command.merchant.others:
    default: op
  cmi.command.migratedatabase:
    description: Changes database system and migrates all data
    default: op
  cmi.command.mirror:
    description: Starts block place/break mirroring.
    default: op
  cmi.command.mobhead:
    description: Get mob head
    default: op
  cmi.command.mobhead.others:
    default: op
  cmi.command.money:
    description: Manage money balance
    default: op
  cmi.command.more:
    description: Fills item stack to maximum amount
    default: op
  ...
  cmi.command.mute:
    ...
    default: op
  cmi.command.mutechat:
    description: Prevent public messages
    default: op
  cmi.command.nameplate:
    description: Set players name plate prefix, suffix or its color
    default: op
  ...
  cmi.command.near:
    ...
    default: op
  cmi.command.nick:
    description: Changes player name
    default: op
  cmi.command.nick.others:
    default: op
  cmi.command.notarget:
    description: Toggle no-mob target mode
    default: op
  cmi.command.notarget.others:
    default: op
  cmi.command.note:
    description: Manage players notes
    default: op
  cmi.command.note.others:
    default: op
  cmi.command.openbook:
    description: Open book gui
    default: true
  ...
  cmi.command.ping.others:
    default: op
  cmi.command.placeholders:
    description: List out all placeholders
    default: op
  cmi.command.playercollision:
    description: Set players collision mode
    default: op
  cmi.command.playercollision.others:
    default: op
  cmi.command.playtime:
    description: Shows player total play time
    default: op
  cmi.command.playtime.others:
    default: op
  cmi.command.playtimetop:
    description: Shows top list of player total play time
    default: op
  cmi.command.point:
    description: Point to block
    default: op
  cmi.command.portals:
    description: Set portals
    default: op
  cmi.command.pos:
    description: Show current position of a player
    default: op
  cmi.command.pos.others:
    default: op
  cmi.command.preview:
    description: Load chunk for given range
    default: op
  cmi.command.prewards:
    description: Check playtime rewards
    default: op
  cmi.command.prewards.others:
    default: op
  cmi.command.ptime:
    description: Controls player personal time
    default: op
  cmi.command.ptime.others:
    default: op
  cmi.command.purge:
    description: Cleans player data from world folder by inactive days
    default: op
  ...
  cmi.command.rankdown:
    description: Decrease your rank
    default: op
  cmi.command.rankdown.others:
    default: op
  cmi.command.rankinfo:
    description: Your rank information
    default: op
  cmi.command.rankinfo.others:
    default: op
  cmi.command.ranklist:
    description: List of possible ranks
    default: op
  cmi.command.rankset:
  ...
  cmi.command.rankup.others:
    default: op
  cmi.command.realname:
    description: Check players real name
    default: op
  cmi.command.recipe:
  ...
  cmi.command.removehome.others:
    default: op
  cmi.command.removeuser:
    description: Removes user and its data
    default: op
  cmi.command.removewarp:
  ...
  cmi.command.repair.others:
    default: op
  cmi.command.repaircost:
    description: Check items repair cost
    default: op
  cmi.command.repaircost.others:
    default: op
  cmi.command.replaceblock:
    description: Replaces blocks in current world around you
    default: op
  cmi.command.reply:
    description: Reply to last message sender
    default: op
  cmi.command.resetback:
    description: Resets players back location
    default: op
  cmi.command.resetback.others:
    default: op
  cmi.command.resetdbfields:
    description: Resets particular database columns to default value
    default: op
  cmi.command.ride:
    description: Ride target entity
    default: op
  cmi.command.rt:
  ...
  cmi.command.rt.others:
    default: op
  cmi.command.sameip:
    description: List players logged in from same ip
    default: op
  cmi.command.saturation:
    description: Set players saturation
    default: op
  cmi.command.saturation.others:
    default: op
  cmi.command.saveall:
    description: Saves every player inventory
    default: op
  cmi.command.saveditems:
    description: Save or manage saved items
    default: op
  ...
  cmi.command.scan:
    ...
    default: op
  cmi.command.scavenge:
    description: Recycle item and its enchantments
    default: op
  cmi.command.scavenge.others:
    default: op
  cmi.command.schedule:
    description: Trigger schedule
    default: op
  cmi.command.se:
    description: Changes sign text line.
    default: op
  cmi.command.search:
    description: Search items/enchants/fly/maxhp/gm/oversize modes and other stuff from all users
    default: op
  cmi.command.search.others:
    default: op
  cmi.command.seen:
    description: Check when player was last seen
    default: op
  cmi.command.select:
    description: Manage selection area
    default: op
  ...
  cmi.command.serverlist.others:
    default: op
  cmi.command.servertime:
    description: Show server time
    default: op
  cmi.command.setenchantworth:
    description: Change enchantment worth
    default: op
  cmi.command.setfirstspawn:
    description: Sets first spawn point
    default: op
  cmi.command.sethome:
  ...
  cmi.command.sethome.others:
    default: op
  cmi.command.setmotd:
    description: Set server motd
    default: op
  cmi.command.setrt:
    description: Set random teleport bounds
    default: op
  cmi.command.setspawn:
    description: Sets spawn command teleport point
    default: op
  cmi.command.setwarp:
    description: Sets warp location
    default: op
  cmi.command.setworth:
    description: Change item worth
    default: op
  cmi.command.shadowmute:
  ...
  cmi.command.silentchest:
    description: Toggles silent chest
    default: op
  cmi.command.sit:
    description: Sit in your position
    default: op
  cmi.command.sit.others:
    default: op
  cmi.command.skin:
    description: Changes players skin
    default: op
  cmi.command.skin.others:
    default: op
  cmi.command.smite:
    description: Strike ground or player with lightning
    default: op
  cmi.command.smite.others:
    default: op
  cmi.command.smithingtable:
  ...
  cmi.command.solve:
    ...
    default: op
  cmi.command.sound:
    description: Play sound at target location
    default: op
  cmi.command.sound.others:
    default: op
  cmi.command.spawn:
    description: Teleports back to spawn location
    default: op
  cmi.command.spawn.others:
    default: op
  cmi.command.spawner:
    description: Sets spawner
    default: op
  cmi.command.spawnereditor:
    description: Edit spawner
    default: op
  ...
  cmi.command.staffmsg:
    ...
    default: op
  cmi.command.stats:
    description: Check players stats
    default: op
  cmi.command.stats.others:
    default: op
  cmi.command.statsedit:
    description: Edit players statistics
    default: op
  cmi.command.status:
    description: Show server status
    default: op
  cmi.command.stonecutter:
    description: Open stonecutter
    default: op
  cmi.command.stonecutter.others:
    default: op
  cmi.command.sudo:
    description: Force another player to perform command
    default: op
  cmi.command.suicide:
  ...
  cmi.command.suicide.others:
    default: op
  cmi.command.switchplayerdata:
    description: Switch all data from one player to another
    default: op
  ...
  cmi.command.tempban:
    ...
    default: op
  cmi.command.tempipban:
    description: Temp ban ip
    default: op
  cmi.command.tfly:
    description: Set temporary players fly mode until relog or until time ends
    default: op
  cmi.command.tfly.others:
    default: op
  cmi.command.tgod:
    description: Set players temporarily god mode until relog or time end
    default: op
  cmi.command.tgod.others:
    default: op
  cmi.command.time:
    description: Controls server time
    default: op
  cmi.command.titlemsg:
  ...
  cmi.command.top.others:
    default: op
  cmi.command.tp:
    description: Teleports to player's location
    default: op
  cmi.command.tp.others:
    default: op
  cmi.command.tpa:
    description: Ask the player if you can teleport to them
    default: op
  cmi.command.tpaall:
    description: Ask all online players to teleport to your location
    default: op
  cmi.command.tpaccept:
    description: Accept teleport request
    default: op
  cmi.command.tpahere:
    description: Asks player to accept teleportation to your location
    default: op
  cmi.command.tpall:
    description: Teleports all online players to location
    default: op
  cmi.command.tpallworld:
    description: Teleports ALL players from specific world
    default: op
  cmi.command.tpbypass:
    description: Bypass teleportation to unsafe location
    default: op
  ...
  cmi.command.tpdeny:
    ...
    default: op
  cmi.command.tphere:
    description: Teleports player to your location
    default: op
  cmi.command.tphere.others:
    default: op
  cmi.command.tpo:
    description: Teleports to player's location by force
    default: op
  cmi.command.tpo.others:
    default: op
  cmi.command.tpohere:
    description: Teleports player to your location by force
    default: op
  cmi.command.tpohere.others:
    default: op
  cmi.command.tpopos:
    description: Teleports to location by force
    default: op
  ...
  cmi.command.unban:
    ...
    default: op
  cmi.command.unbreakable:
    description: Makes item unbreakable
    default: op
  cmi.command.unbreakable.others:
    default: op
  cmi.command.uncondense:
    description: Uncondense items into smaller parts
    default: op
  ...
  cmi.command.unjail:
    ...
    default: op
  cmi.command.unloadchunks:
    description: Unloads chunks from server memory
    default: op
  cmi.command.unmute:
    description: Unmute player
    default: op
  cmi.command.unmutechat:
    description: Unmute public chat
    default: op
  cmi.command.usermeta:
    description: Manage players meta data
    default: op
  cmi.command.util:
  ...
  cmi.command.vanish.others:
    default: op
  cmi.command.vanishedit:
    description: Edit vanish mode for player
    default: op
  ...
  cmi.command.version:
    ...
    default: op
  cmi.command.viewrange:
    description: Change view range
    default: op
  cmi.command.viewrange.others:
    default: op
  cmi.command.voteedit:
    description: Manage players votes
    default: op
  cmi.command.voteedit.others:
    default: op
  cmi.command.votes:
    description: Check players vote count
    default: op
  cmi.command.votes.others:
    default: op
  cmi.command.votetop:
    description: Check top vote list
    default: op
  cmi.command.votetop.others:
    default: op
  cmi.command.walkspeed:
    description: Set players walk speed from 0 to 10
    default: op
  ...
  cmi.command.warn:
    ...
    default: op
  cmi.command.warnings:
    description: Check player warnings
    default: op
  cmi.command.warnings.others:
    default: op
  cmi.command.warp:
    description: Teleports to warp location
    default: op
  cmi.command.warp.others:
    default: op
  cmi.command.warpgroups:
    description: Lists warp groups
    default: op
  cmi.command.weather:
  ...
  cmi.command.workbench.others:
    default: op
  cmi.command.world:
    description: Teleports to different world
    default: op
  cmi.command.world.others:
    default: op
  cmi.command.worth:
    description: Check item worth
    default: op
  cmi.command.worthlist:
    description: Check list of items with set sell prices
    default: op
