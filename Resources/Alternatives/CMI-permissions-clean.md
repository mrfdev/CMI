...
```
  ...
  cmi.command.chatcolor:
    description: Pick chat color
    default: op
  cmi.command.chatcolor.others:
    default: op
  ...
  cmi.command.donate:
    ...
    default: op
  cmi.command.down:
    description: Teleport one floor down
    default: op
  ...
  cmi.command.generateworth:
    description: Auto generate possible item worth values
    default: op
  cmi.command.getbook:
  ...
  cmi.command.walkspeed:
    description: Set players walk speed from 0 to 5
    default: op
