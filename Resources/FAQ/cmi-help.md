...
**CMI can handle custom /help**, this is the recommended setup that works well with other plugins on Spigot/Paper 1.16.5 for a dynamic and flexible way of displaying /help. And yes, you can use CMI custom commands with CMI 9 on Spigot 1.17.
