...
**CMI can handle custom /help**, this is the recommended setup that works well with other plugins on Spigot/Paper 1.16.1 for a dynamic and flexible way of displaying /help.
