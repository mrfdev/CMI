...
The full list as of October 27th, 2021

- CMI version 9.0.6.1
- Selection Visualizer version 3.0.5.0
- TryMe version 7.0.0.2
- Mob Farm Manager version 2.0.0.2
- Residence version 5.0.0.4
- Jobs-Reborn version 5.0.0.9
- BottledExp version 3.0.0.3
- ReCount version 3.5.0
- TradeMe version 6.1.0.4

These currently support Spigot-, and Paper 1.17.1 and lower, and require the CMILib version 1.0.4.2 or newer to properly operate.
