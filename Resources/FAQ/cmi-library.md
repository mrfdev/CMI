...
The full list as of April 20th, 2022

- CMI version 9.1.4.1
- Selection Visualizer version 3.1.1.1
- TryMe version 7.0.0.2
- Mob Farm Manager version 2.0.1.2
- Residence version 5.0.1.5
- Jobs-Reborn version 5.0.2.1
- BottledExp version 3.0.2.0
- ReCount version 3.5.1
- TradeMe version 6.1.1.1

These currently support Spigot-, and Paper 1.18.2 and lower, and require the CMILib version 1.1.2.5 or newer to properly operate.
