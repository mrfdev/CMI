...
The full list as of July 22nd, 2021

- CMI version 9.0.1.3
- Selection Visualizer version 3.0.5.0
- TryMe version 7.0.0.1
- Mob Farm Manager version 2.0.0.0
- Residence version 5.0.0.1
- Jobs-Reborn version 5.0.0.6
- BottledExp version 3.0.0.1
- ReCount version 3.5.0
- TradeMe version 6.1.0.0

These currently support Spigot-, and Paper 1.17.1 and lower, and require the CMI Lib version 1.0.2.14 or newer to properly operate.
