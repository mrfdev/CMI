...
- CMI version 9.0.1.0 is considered the Stable version you can run on a live production environment. It is stable enough for 1.17.1, if you want to run it live that's fine. But backup your data and test things first!
- CMI Lib version 1.0.2.11 or older will automatically download. It will replace older CMI Lib jars. This is okay.
