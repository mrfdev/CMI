...
<img width="449" alt="paper-1 17 1-cmi-9 0 2 2-cmilib-1 0 3 2" src="https://user-images.githubusercontent.com/28841349/127595098-c0107f4a-5fc8-4607-a31f-227c0ea98142.png">
...
- CMI version 9.0.2.2 is considered the Stable version you can run on a live production environment. It is stable enough for 1.17.1, if you want to run it live that's fine. But backup your data and test things first!
- CMI Lib version 1.0.3.2 or older will automatically download. It will replace older CMI Lib jars. This is okay.
