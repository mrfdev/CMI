...
**CMI can handle custom /rules**, this is the recommended setup that works well with other plugins on Spigot/Paper 1.16.5 for a dynamic and flexible way of displaying /rules.
